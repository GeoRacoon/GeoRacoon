...
|---|-------------------------------------------------------------|---|---|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `alps_elevation_mean_GLO90DEM_sinusoidal.tif` | Copernicus DEM GLO-90 (90 m global DEM)                     | Copernicus / ESA|  | Cropped to Alps extent; spatially resampled to ~1km pixel size in a sinusoidal projection; meaned elevation data for resampling|
| `alps_lst-day-mean_summer_2015_MOD11AS_sinusoidal.tif` | MODIS Land Surface Temperature MOD11A2 V6.1 8-Day average   | NASA LP DAAC / USGS |  | Cropped to Alps extent; averaged to a summer daytime mean, 2015. |
